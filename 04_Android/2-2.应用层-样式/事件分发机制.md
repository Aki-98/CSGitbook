...
![image-20220414164743405](事件分发机制_imgs\9gFTDG2tPl3.png)

此处需要特别说明：事件列，即指从手指接触屏幕至手指离开屏幕这个过程产生的一系列事件。一般情况下，事件列都是以DOWN事件开始、UP事件结束，中间有无数的MOVE事件。

![image-20220414164759290](事件分发机制_imgs\PDH9qj9ebe5.png)
...
![image-20220414164819052](事件分发机制_imgs\wcU9g0o00hD.png)

![image-20220414164840825](事件分发机制_imgs\7ikgISdr5oP.png)
...
![image-20220414164940418](事件分发机制_imgs\hkDqmuLnfQs.png)

### 1.6 总结

![image-20220414165007656](事件分发机制_imgs\zltHQe8Khme.png)
...
![image-20220414165237533](事件分发机制_imgs\5dubVIUgQo2.png)

![image-20220414165423739](事件分发机制_imgs\pgDGiCZFjrD.png)
