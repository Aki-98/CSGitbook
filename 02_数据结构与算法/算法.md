...
![image-20220327153014348](算法_imgs\image-20220327153014348.png)
...
`![image-20220307183813088](算法_imgs\image-20220307183813088.png)

**渐进符号**

设n为算法中的问题规模，通常用大O、大![image-20220307183902204](算法_imgs\image-20220307183902204.png)和![image-20220307183913322](算法_imgs\image-20220307183913322.png)等三种渐进符号表示算法的执行时间与n之间的一种增长关系。 

![image-20220307184115884](算法_imgs\image-20220307184115884.png)

![image-20220307185252381](算法_imgs\image-20220307185252381.png)

![image-20220307185318461](算法_imgs\image-20220307185318461.png)

![image-20220307185334165](算法_imgs\image-20220307185334165.png)

![image-20220307185413637](算法_imgs\image-20220307185413637.png)

![image-20220307185457516](算法_imgs\image-20220307185457516.png)

![image-20220307190630719](算法_imgs\image-20220307190630719.png)

等差数列{an}的通项公式为：an=a1+(n-1)d。 前n项和公式为：$Sn=n*a1+n(n-1)d/2$

![image-20220307191127695](算法_imgs\image-20220307191127695.png)

![image-20220307191203471](算法_imgs\image-20220307191203471.png)

![image-20220307192032287](算法_imgs\image-20220307192032287.png)

![image-20220307192046048](算法_imgs\image-20220307192046048.png)

![image-20220307192259441](算法_imgs\image-20220307192259441.png)

![image-20220307192552511](算法_imgs\image-20220307192552511.png)
...
![image-20220307193820409](算法_imgs\image-20220307193820409.png)
...
![image-20220307194028434](算法_imgs\image-20220307194028434.png)

![image-20220307194107178](算法_imgs\image-20220307194107178.png)

![image-20220307194125234](算法_imgs\image-20220307194125234.png)

![image-20220307194140162](算法_imgs\image-20220307194140162.png)
...
![image-20220307224051765](算法_imgs\image-20220307224051765.png)

其中渐进符号的含义与时间复杂度中的含义相同。

![image-20220307224236502](算法_imgs\image-20220307224236502.png)
...
![image-20220307194352514](算法_imgs\image-20220307194352514.png)

![image-20220307194413067](算法_imgs\image-20220307194413067.png)

![image-20220307194425714](算法_imgs\image-20220307194425714.png)
...
![image-20220307203914079](算法_imgs\image-20220307203914079.png)
...
![image-20220307215310613](算法_imgs\image-20220307215310613.png)
...
![image-20220308213439758](算法_imgs\image-20220308213439758.png)

### 递归模型

递归模型是递归算法的抽象，它反映一个递归问题的递归结构。例如前面的递归算法对应的递归模型如下：

![image-20220308213724940](算法_imgs\image-20220308213724940.png)
...
![image-20220308213853530](算法_imgs\image-20220308213853530.png)

这里的s1与m1均为常量，有些递归问题可能有几个递归出口。

递归体的一般格式如下：

![image-20220308213935619](算法_imgs\image-20220308213935619.png)
...
![image-20220308215714480](算法_imgs\image-20220308215714480.png)

由此得到递归模型如下：

![image-20220308215829470](算法_imgs\image-20220308215829470.png)
...
![image-20220309211320466](算法_imgs\image-20220309211320466.png)

![image-20220309211504945](算法_imgs\image-20220309211504945.png)
...
![image-20220312160540263](算法_imgs\image-20220312160540263.png)
...
![image-20220312160814593](算法_imgs\image-20220312160814593.png)

![image-20220312160903863](算法_imgs\image-20220312160903863.png)
...
![image-20220312161115997](算法_imgs\image-20220312161115997.png)

![image-20220312161140782](算法_imgs\image-20220312161140782.png)

对应的递归模型如下：

![image-20220312161400958](算法_imgs\image-20220312161400958.png)
...
![微信图片_20220314193000](算法_imgs\微信图片_20220314193000.jpg)

递归算法和树的关系

![微信图片_20220314192903](算法_imgs\微信图片_20220314192903.jpg)

通用代码格式

![微信图片_20220314193014](算法_imgs\微信图片_20220314193014.jpg)
...
![image-20220314193730047](算法_imgs\image-20220314193730047.png)

![image-20220314195621554](算法_imgs\image-20220314195621554.png)

![image-20220314195636716](算法_imgs\image-20220314195636716.png)

![image-20220314195720619](算法_imgs\image-20220314195720619.png)

![image-20220314195731755](算法_imgs\image-20220314195731755.png)

![image-20220314200153370](算法_imgs\image-20220314200153370.png)

![image-20220314200500338](算法_imgs\image-20220314200500338.png)

![image-20220314200532018](算法_imgs\image-20220314200532018.png)

![image-20220314200839323](算法_imgs\image-20220314200839323.png)

![image-20220314200849794](算法_imgs\image-20220314200849794.png)

#### 非齐次递推式的求解

常系数的线性非齐次递推式的一般格式如下：

![image-20220314200938282](算法_imgs\image-20220314200938282.png)
